...
| --------------- | ------------------------------- | -------------------------------------------------- | ------------------------------------------------------ |
| `ubuntu-latest` | [`node:12-buster-slim`][micro]  | [`ghcr.io/catthehacker/ubuntu:act-latest`][medium] | [`ghcr.io/catthehacker/ubuntu:full-latest`][large-cat] |
| `ubuntu-20.04`  | [`node:12-buster-slim`][micro]  | [`ghcr.io/catthehacker/ubuntu:act-20.04`][medium]  | [`ghcr.io/catthehacker/ubuntu:full-20.04`][large-cat]  |
| `ubuntu-18.04`  | [`node:12-buster-slim`][micro]  | [`ghcr.io/catthehacker/ubuntu:act-18.04`][medium]  | [`nektos/act-environments-ubuntu:18.04`][large-act]    |
| `ubuntu-16.04`  | [`node:12-stretch-slim`][micro] | [`ghcr.io/catthehacker/ubuntu:act-16.04`][medium]  | `unavailable`                                          |
