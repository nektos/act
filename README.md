...
Let's see it in action with a [sample repository](https://github.com/cplee/github-actions-demo)!
...
- Clone this repository `git clone git@github.com:nektos/act.git`
