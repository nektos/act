...
func (cr *containerReference) UpdateFromEnv(srcPath string, env *map[string]string, lenient bool) common.Executor {
	return parseEnvFile(cr, srcPath, env, lenient).IfNot(common.Dryrun)
}
