...
func TestEvaluate(t *testing.T) {
	...
	tables := []struct {
		...
		{"contains(fromJSON('[\"foo\",\"bar\"]'), 'd')", "false", ""},
		...
		{"format('echo Hello {0}: {1}', secrets['case_insensitive_secret'], secrets[  'Case_insensitive_secret' \t ])", "echo Hello value: value", ""},
		{"format('echo Hello {0}:\n{1}', secrets['case_insensitive_secret'], secrets[  'Case_insensitive_secret' \t ])", "echo Hello value:\nvalue", ""},
		{"format('{0}', '{1}', 'World')", "{1}", ""},
		{"format('{{{0}', '{1}', 'World')", "{{1}", ""},
		{"format('{0}}', '{1}', 'World')", "", "SyntaxError: The following format string is invalid: '{0}}'"},
		{"format('{2}', '{1}', 'World')", "", "SyntaxError: The following format string references more arguments than were supplied: '{2}'"},
		{"format('{8}')", "", "SyntaxError: The following format string references more arguments than were supplied: '{8}'"},
		{"format('{2147483648}')", "", "SyntaxError: The following format string is invalid: '{2147483648}'. Error: strconv.ParseInt: parsing \"2147483648\": value out of range"},
		{"format('{3147483648}')", "", "SyntaxError: The following format string is invalid: '{3147483648}'. Error: strconv.ParseInt: parsing \"3147483648\": value out of range"},
		{"(fromJSON('{\"foo\":\"bar}')).foo", "", "fromJSON: Unable to unmarshal json '{\"foo\":\"bar}', unexpected end of JSON input"},
		{"join(fromJSON('[\"Test\", {\"foo\":\"bar\"}]'), 'foo')", "", "TypeError: Array Element 1 is not a string value 'map[foo:bar]'"},
	}
